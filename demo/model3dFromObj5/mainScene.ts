...
export class MainScene extends Scene {
    ...
    public onPreloading():void {
        ...
        this.dataTextureLink = this.resourceLoader.loadTexture('./model3dFromObj5/moon.jpg');
        this.dataTextureNormalLink = this.resourceLoader.loadTexture('./model3dFromObj5/moon_normal.jpg');
    }
