...
export class MainScene extends Scene {
    ...
    public onPreloading() {
        ...
        this.dataTextureLink = this.resourceLoader.loadImage('./model3dFromObj5/moon.jpg');
        this.dataTextureNormalLink = this.resourceLoader.loadImage('./model3dFromObj5/moon_normal.jpg');
    }
