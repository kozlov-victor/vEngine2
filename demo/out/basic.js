...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return KeyboardControl; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _engine_control_abstract_abstractKeypad__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(53);
...
var KeyboardControl = (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "c"](KeyboardControl, _super);
    ...
    KeyboardControl.prototype.on = function (e, callback) {
        this.emitter.on(e, callback);
    };
    KeyboardControl.prototype.off = function (e, callback) {
...
"use strict";
/* unused harmony export KEY_STATE */
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AbstractKeypad; });
/* harmony import */ var _engine_misc_eventEmitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(38);
/* harmony import */ var _engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(34);
/* harmony import */ var _engine_misc_fastMap__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(37);
...
var AbstractKeypad = (function () {
    function AbstractKeypad(game) {
        this.emitter = new _engine_misc_eventEmitter__WEBPACK_IMPORTED_MODULE_0__[/* EventEmitter */ "a"]();
        this.buffer = new _engine_misc_fastMap__WEBPACK_IMPORTED_MODULE_2__[/* FastMap */ "a"]();
        this.game = game;
    }
    AbstractKeypad.prototype.press = function (key) {
        ...
        this.notify(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].keyPressed, key);
    };
    AbstractKeypad.prototype.release = function (key) {
        if (this.isReleased(key))
            return;
        this.buffer.put(key, KEY_STATE.KEY_JUST_RELEASED);
        this.notify(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].keyReleased, key);
    };
    ...
    AbstractKeypad.prototype.update = function () {
        var keys = this.buffer.getKeys();
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
            var keyNum = keys_1[_i];
            var keyVal = this.buffer.get(keyNum);
            if (keyVal === KEY_STATE.KEY_RELEASED)
                this.buffer.remove(keyNum);
            else if (keyVal === KEY_STATE.KEY_JUST_RELEASED)
                this.buffer.put(keyNum, KEY_STATE.KEY_RELEASED);
            if (keyVal === KEY_STATE.KEY_JUST_PRESSED) {
                this.buffer.put(keyNum, KEY_STATE.KEY_PRESSED);
            }
            this.notify(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].keyHold, keyNum);
        }
    };
    AbstractKeypad.prototype.notify = function (e, key) {
        this.emitter.trigger(e, key);
...
// EXTERNAL MODULE: ./engine/control/keyboardControl.ts
var keyboardControl = __webpack_require__(50);
...
// EXTERNAL MODULE: ./engine/control/abstract/keyboardEvents.ts
var keyboardEvents = __webpack_require__(34);

// CONCATENATED MODULE: ./demo/basic/mainScene.ts
...
var mainScene_MainScene = (function (_super) {
    ...
    MainScene.prototype.onPreloading = function () {
        ...
        var rect = new rectangle["a" /* Rectangle */](this.game);
    ...
    MainScene.prototype.onReady = function () {
        ...
        this.game.getControl(keyboardControl["b" /* KeyboardControl */]).on(keyboardEvents["a" /* KEYBOARD_EVENTS */].keyHold, function (e) {
            switch (e) {
                case keyboardControl["a" /* KEYBOARD_KEY */].LEFT:
                    _this.logoObj.pos.addX(-1);
                    break;
                case keyboardControl["a" /* KEYBOARD_KEY */].RIGHT:
                    _this.logoObj.pos.addX(1);
                    break;
                case keyboardControl["a" /* KEYBOARD_KEY */].UP:
                    _this.logoObj.pos.addY(-1);
                    break;
                case keyboardControl["a" /* KEYBOARD_KEY */].DOWN:
                    _this.logoObj.pos.addY(1);
                    break;
                case keyboardControl["a" /* KEYBOARD_KEY */].R:
...
// CONCATENATED MODULE: ./demo/basic/index.ts




var basic_game = new game["a" /* Game */]();
basic_game.setRenderer(webGlRenderer["a" /* WebGlRenderer */]);
basic_game.addControl(keyboardControl["b" /* KeyboardControl */]);
var mainScene = new mainScene_MainScene(basic_game);
basic_game.runScene(mainScene);
