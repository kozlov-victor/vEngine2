...
export class MainScene extends Scene {
    ...
    public onPreloading() {
        ...
        const polyLine5:PolyLine = PolyLine.fromPoints(this.game,`
                    50,375
        ...
        const polyLine6:PolyLine = PolyLine.fromPoints(this.game,`50,80 140,80 80,100 180,100 160,85 160,115 180,100`);
