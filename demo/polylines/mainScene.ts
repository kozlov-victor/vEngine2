...
export class MainScene extends Scene {
    ...
    public onPreloading() {
        ...
        polyLine1.complete();
        polyLine1.fromSvgPath(`M 1 1 L 7 1 L 7 -1 L 2 -3 L 1 1`);
