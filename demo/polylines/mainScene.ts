...
export class MainScene extends Scene {
    ...
    public override onPreloading(taskQueue:TaskQueue):void {
        ...
        polyLine4.color.setRGB(12,2,233);
        ...
        polyLine5.color.setRGB(234,12,34);
        ...
        const polyLine6:PolyLine = PolyLine.fromVertices(this.game,`50,80 140,80 80,100 180,100 160,85 160,115 180,100`,{lineWidth:2});
        polyLine6.pos.setXY(135,-50);
        polyLine6.color.setRGB(122,12,122);
