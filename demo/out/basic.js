...
(function (KEYBOARD_EVENTS) {
    KEYBOARD_EVENTS[KEYBOARD_EVENTS["KEY_PRESSED"] = 0] = "KEY_PRESSED";
    KEYBOARD_EVENTS[KEYBOARD_EVENTS["KEY_RELEASED"] = 1] = "KEY_RELEASED";
    KEYBOARD_EVENTS[KEYBOARD_EVENTS["KEY_HOLD"] = 2] = "KEY_HOLD";
...
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _engine_control_abstract_abstractKeypad__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(48);
/* harmony import */ var _engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(34);
...
var KeyboardControl = (function (_super) {
    ...
    KeyboardControl.prototype.on = function (e, callback) {
        this.emitter.on(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_2__[/* KEYBOARD_EVENTS */ "a"][e], callback);
    };
...
/* harmony import */ var _engine_misc_eventEmitter__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(36);
...
var AbstractKeypad = (function () {
    ...
    AbstractKeypad.prototype.press = function (key) {
        ...
        this.emitter.trigger(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"][_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].KEY_PRESSED], key);
    };
    AbstractKeypad.prototype.release = function (key) {
        if (this.isReleased(key))
            return;
        this.buffer.put(key, KEY_STATE.KEY_JUST_RELEASED);
        this.emitter.trigger(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"][_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].KEY_RELEASED], this.buffer.get(key));
    };
    ...
    AbstractKeypad.prototype.update = function () {
        ...
        for (var _i = 0, keys_1 = keys; _i < keys_1.length; _i++) {
            ...
            this.emitter.trigger(_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"][_engine_control_abstract_keyboardEvents__WEBPACK_IMPORTED_MODULE_1__[/* KEYBOARD_EVENTS */ "a"].KEY_HOLD], keyNum);
        }
    };
...
var keyboardControl = __webpack_require__(47);
...
var mainScene_MainScene = (function (_super) {
    ...
    MainScene.prototype.onReady = function () {
        ...
        this.game.getControl(keyboardControl["b" /* KeyboardControl */]).on(keyboardEvents["a" /* KEYBOARD_EVENTS */].KEY_HOLD, function (e) {
            switch (e) {
