...
export class MainScene extends Scene {
    ...
    private cubeTextureLink:ResourceLink<ITexture>;

    public onPreloading() {
        this.cubeTextureLink = this.resourceLoader.loadImage('./cubeTexture/textures/cm_back.jpg');
    }
    ...
    public onReady() {
        ...
        obj.texture = this.cubeTextureLink.getTarget();
