...
Object.defineProperty(exports, "__esModule", { value: true });
var mainScene_1 = __webpack_require__(93);
...
var MainScene = (function (_super) {
    ...
    MainScene.prototype.onReady = function () {
        ...
        this.game.keyboard.on(keyboard_1.KEYBOARD_EVENT.KEY_HOLD, function (e) {
            switch (e) {
                case keyboard_1.KEY.LEFT:
                    _this.logoObj.pos.addX(-1);
                    break;
                case keyboard_1.KEY.RIGHT:
                    _this.logoObj.pos.addX(1);
                    break;
                case keyboard_1.KEY.UP:
                    _this.logoObj.pos.addY(-1);
                    break;
                case keyboard_1.KEY.DOWN:
                    _this.logoObj.pos.addY(1);
                    break;
                case keyboard_1.KEY.R:
