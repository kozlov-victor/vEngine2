...
export class Unescaper {
    ...
    static PATTERN_ESCAPED_CHARACTER = new Pattern('\\\\([0abt\tnvfre "\\/\\\\N_LP]|x[0-9a-fA-F]{2}|u[0-9a-fA-F]{4}|U[0-9a-fA-F]{8})');

    static _unescapeCallback: any = null!;
    ...
    static unescapeDoubleQuotedString(value: string): string {
        if (this._unescapeCallback == null) {
            this._unescapeCallback = (str: string) => {
    ...
    static unescapeCharacter(value: string) {
