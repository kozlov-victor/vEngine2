...
/* harmony import */ var _engine_misc_object__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(11);
...
/* harmony import */ var _engine_misc_objectPool__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(12);
...
/* harmony import */ var _misc_objectPool__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(12);
...
var RenderableModel = (function () {
    ...
    Object.defineProperty(RenderableModel.prototype, "angleVelocity", {
        get: function () {
            return this._angle;
        },
        set: function (val) {
    ...
    RenderableModel.prototype.update = function () {
        ...
        if (this.angleVelocity3d.x)
            this.angle3d.x += this.angleVelocity3d.x * delta / 1000;
        if (this.angleVelocity3d.y)
            this.angle3d.y += this.angleVelocity3d.y * delta / 1000;
        if (this.angleVelocity3d.z)
            this.angle3d.z += this.angleVelocity3d.z * delta / 1000;
...
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "e", function() { return removeFromArray; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "d", function() { return parametrizeString; });
...
var ObservableEntity = (function () {
    ...
    ObservableEntity.prototype.removeOnChangeListener = function (f) {
        Object(_engine_misc_object__WEBPACK_IMPORTED_MODULE_0__[/* removeFromArray */ "e"])(this._onChanged, function (it) { return it === f; });
    };
...
var Camera = (function () {
    ...
    Camera.prototype.shake = function (amplitude, time) {
        ...
        this.cameraShakeTween = new _animation_tween__WEBPACK_IMPORTED_MODULE_1__[/* Tween */ "a"]({
            target: tweenTarget,
            time: time,
            to: { time: time },
            progress: function () {
...
var timer_Timer = (function () {
    ...
    Timer.prototype.kill = function () {
        var _this = this;
        Object(object["e" /* removeFromArray */])(this.parent.getTimers(), function (it) { return it === _this; });
    };
    return Timer;
}());
...
var abstract_container = __webpack_require__(27);
...
// EXTERNAL MODULE: ./engine/renderable/impl/geometry/image.ts
...
var shapeDrawer_ShapeDrawer = (function (_super) {
    ...
    function ShapeDrawer(gl) {
        ...
        gen.setFragmentMainFn(Object(object["d" /* parametrizeString */])(shape_fragment, {
            __STRETCH_MODE_STRETCH__: geometry_image["b" /* STRETCH_MODE */].STRETCH,
            __STRETCH_MODE_REPEAT__: geometry_image["b" /* STRETCH_MODE */].REPEAT,
...
var meshDrawer_MeshDrawer = (function (_super) {
    ...
    MeshDrawer.prototype.setTectureMatrix = function (m) {
...
// EXTERNAL MODULE: ./engine/renderable/abstract/renderableModel.ts
...
var BLACK = color["a" /* Color */].RGB(0, 0, 0, 0).freeze();
var makePositionMatrix = function (rect, viewSize, matrixStack) {
    ...
    var matrix4;
    var useOrtho = !!(window.ortho);
    if (!useOrtho) {
        matrix4 = webGlRenderer_Mat16Holder.fromPool();
...
var webGlRenderer_WebGlRenderer = (function (_super) {
    ...
    WebGlRenderer.prototype.drawMesh = function (mesh) {
        ...
        if (isTextureUsed)
            md.setTectureMatrix(FLIP_TEXTURE_MATRIX.mat16);
...
var Scene = (function () {
    function Scene(game) {
        this.game = game;
        this.type = "Scene";
        this.colorBG = _engine_renderer_color__WEBPACK_IMPORTED_MODULE_1__[/* Color */ "a"].WHITE.clone();
        this.filters = [];
        this._layers = [];
        this._tweenDelegate = new _engine_delegates_tweenableDelegate__WEBPACK_IMPORTED_MODULE_5__[/* TweenableDelegate */ "a"]();
        this._timerDelegate = new _engine_delegates_timerDelegate__WEBPACK_IMPORTED_MODULE_6__[/* TimerDelegate */ "a"]();
        this._eventEmitterDelegate = new _engine_delegates_eventEmitterDelegate__WEBPACK_IMPORTED_MODULE_7__[/* EventEmitterDelegate */ "a"]();
        this._uiLayer = new _renderable_impl_general_layer__WEBPACK_IMPORTED_MODULE_0__[/* Layer */ "a"](this.game);
        this.resourceLoader = new _engine_resources_resourceLoader__WEBPACK_IMPORTED_MODULE_3__[/* ResourceLoader */ "a"](game);
    }
    ...
    Scene.prototype.getDefaultLayer = function () {
        if (!this._layers.length)
            this.addLayer(new _renderable_impl_general_layer__WEBPACK_IMPORTED_MODULE_0__[/* Layer */ "a"](this.game));
    ...
    Scene.prototype.removeLayer = function (layer) {
        Object(_engine_misc_object__WEBPACK_IMPORTED_MODULE_4__[/* removeFromArray */ "e"])(this._layers, function (it) { return it === layer; });
    };
    ...
    Scene.prototype.render = function () {
        ...
        this.game.camera.matrixMode = _engine_renderer_camera__WEBPACK_IMPORTED_MODULE_2__[/* CAMERA_MATRIX_MODE */ "a"].MODE_TRANSFORM;
        if (!this.resourceLoader.isCompleted()) {
            if (this.preloadingGameObject !== undefined) {
...
var mousePoint_MousePoint = (function (_super) {
    tslib_es6["c" /* __extends */](MousePoint, _super);
    function MousePoint() {
...
var mouseControl_MouseControl = (function () {
    ...
    MouseControl.triggerGameObjectEvent = function (e, eventName, point, go) {
        var rectWithOffset = rect["a" /* Rect */].fromPool().set(go.getWorldRect());
        var res = false;
        if (mathEx["a" /* MathEx */].isPointInRect(point, rectWithOffset)) {
            point.target = go;
            var iMousePoint = {
                screenX: point.x,
                screenY: point.y,
    ...
    MouseControl.prototype.resolveClick = function (e) {
        ...
        this.triggerEvent(e, mouseEvents["a" /* MOUSE_EVENTS */].mouseDown);
    ...
    MouseControl.prototype.resolveMouseMove = function (e, isMouseDown) {
        ...
        if (lastMouseDownObject && lastMouseDownObject !== point.target) {
            lastMouseDownObject.trigger(mouseEvents["a" /* MOUSE_EVENTS */].mouseLeave, point);
        }
    };
    MouseControl.prototype.resolveMouseUp = function (e) {
        ...
        if (point.target !== lastMouseDownObject)
            lastMouseDownObject.trigger(mouseEvents["a" /* MOUSE_EVENTS */].mouseUp, point);
        delete this.objectsCaptured[point.id];
    };
    MouseControl.prototype.resolveDoubleClick = function (e) {
        var point = this.triggerEvent(e, mouseEvents["a" /* MOUSE_EVENTS */].doubleClick);
    };
    MouseControl.prototype.resolveScroll = function (e) {
        var point = this.triggerEvent(e, mouseEvents["a" /* MOUSE_EVENTS */].scroll);
    };
    return MouseControl;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "b", function() { return FRAME_ANIMATION_EVENTS; });
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return AbstractFrameAnimation; });
/* harmony import */ var _engine_delegates_eventEmitterDelegate__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(24);
/* harmony import */ var _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(0);


var FRAME_ANIMATION_EVENTS = {
    completed: 'completed',
    loop: 'loop'
};
var AbstractFrameAnimation = (function () {
    function AbstractFrameAnimation(game) {
        this.game = game;
        this.duration = 1000;
        this.isRepeat = true;
        this.frames = [];
        ...
        this._eventEmitterDelegate = new _engine_delegates_eventEmitterDelegate__WEBPACK_IMPORTED_MODULE_0__[/* EventEmitterDelegate */ "a"]();
    }
    AbstractFrameAnimation.prototype.revalidate = function () {
        if ( true && !this.frames.length)
            throw new _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_1__[/* DebugError */ "a"]("animation frames can not be empty");
        this._timeForOneFrame = ~~(this.duration / this.frames.length);
        this.onNextFrame(0);
    };
    AbstractFrameAnimation.prototype.play = function () {
        if ( true && !this.parent)
            throw new _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_1__[/* DebugError */ "a"]("can not play frame animation: it is not attached to parent");
        this._isPlaying = true;
    };
    AbstractFrameAnimation.prototype.stop = function () {
        if ( true && !this.parent)
            throw new _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_1__[/* DebugError */ "a"]("can not stop frame animation: it is not attached to parent");
        this._isPlaying = false;
        this._startTime = 0;
        this._loopReached = false;
    };
    AbstractFrameAnimation.prototype.update = function () {
        if (!this._isPlaying)
            return;
        ...
        var currFrame = ~~((this.frames.length) * delta / this.duration);
        currFrame = currFrame % this.frames.length;
        if (currFrame === this._currFrame)
            return;
    ...
    AbstractFrameAnimation.prototype.off = function (eventName, callBack) {
        this._eventEmitterDelegate.off(eventName, callBack);
    };
    AbstractFrameAnimation.prototype.on = function (eventName, callBack) {
        return this._eventEmitterDelegate.on(eventName, callBack);
    };
    AbstractFrameAnimation.prototype.trigger = function (eventName, data) {
        this._eventEmitterDelegate.trigger(eventName, data);
    };
    AbstractFrameAnimation.prototype.afterCloned = function (g) { };
    AbstractFrameAnimation.prototype.setClonedProperties = function (cloned) {
        cloned.frames = this.frames.slice();
        cloned.duration = this.duration;
        cloned.isRepeat = this.isRepeat;
        cloned.name = this.name;
    };
    return AbstractFrameAnimation;
}());
...
"use strict";
/* harmony export (binding) */ __webpack_require__.d(__webpack_exports__, "a", function() { return CellFrameAnimation; });
/* harmony import */ var tslib__WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(1);
/* harmony import */ var _engine_animation_frameAnimation_abstract_abstractFrameAnimation__WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(62);
/* harmony import */ var _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_2__ = __webpack_require__(0);



var CellFrameAnimation = (function (_super) {
    tslib__WEBPACK_IMPORTED_MODULE_0__[/* __extends */ "c"](CellFrameAnimation, _super);
    function CellFrameAnimation() {
        var _this = _super !== null && _super.apply(this, arguments) || this;
        _this.type = 'CellFrameAnimation';
        _this._numOfFramesH = 1;
        _this._numOfFramesV = 1;
        return _this;
    }
    CellFrameAnimation.prototype.setSpriteSheet = function (spr, numOfFramesH, numOfFramesV) {
        this._spriteSheet = spr;
        this._numOfFramesH = numOfFramesH;
        this._numOfFramesV = numOfFramesV;
    };
    CellFrameAnimation.prototype.revalidate = function () {
        if ( true && !this._spriteSheet)
            throw new _engine_debug_debugError__WEBPACK_IMPORTED_MODULE_2__[/* DebugError */ "a"]("cellFrameAnimation needs spriteSheet! Invoke setSpriteSheet() method");
        var _a = this._spriteSheet.getResourceLink().getTarget().size, width = _a.width, height = _a.height;
        var frameWidth = ~~(width / this._numOfFramesH);
        var frameHeight = ~~(height / this._numOfFramesV);
        this._spriteSheet.getSrcRect().setWH(frameWidth, frameHeight);
        this._spriteSheet.size.setWH(frameWidth, frameHeight);
        _super.prototype.revalidate.call(this);
    };
    CellFrameAnimation.prototype.clone = function () {
        var cloned = new CellFrameAnimation(this.game);
        this.setClonedProperties(cloned);
        return cloned;
    };
    CellFrameAnimation.prototype.afterCloned = function (g) {
        _super.prototype.afterCloned.call(this, g);
        this.setSpriteSheet(g.sprite, this._numOfFramesH, this._numOfFramesV);
    };
    CellFrameAnimation.prototype.onNextFrame = function (i) {
        this.setFrameIndex(this.frames[i]);
    };
    CellFrameAnimation.prototype.setClonedProperties = function (cloned) {
        cloned._numOfFramesH = this._numOfFramesH;
        cloned._numOfFramesV = this._numOfFramesV;
        _super.prototype.setClonedProperties.call(this, cloned);
    };
    CellFrameAnimation.prototype.getFramePosX = function (frameIndex) {
        return (frameIndex % this._numOfFramesH) * this._spriteSheet.getSrcRect().size.width;
    };
    CellFrameAnimation.prototype.getFramePosY = function (frameIndex) {
        return ~~(frameIndex / this._numOfFramesH) * this._spriteSheet.getSrcRect().size.height;
    };
    CellFrameAnimation.prototype.setFrameIndex = function (frameIndex) {
        this._spriteSheet.getSrcRect().setXY(this.getFramePosX(frameIndex), this.getFramePosY(frameIndex));
    };
    return CellFrameAnimation;
}(_engine_animation_frameAnimation_abstract_abstractFrameAnimation__WEBPACK_IMPORTED_MODULE_1__[/* AbstractFrameAnimation */ "a"]));
...
// EXTERNAL MODULE: ./engine/renderable/impl/general/gameObject.ts
var gameObject = __webpack_require__(54);

// EXTERNAL MODULE: ./engine/animation/frameAnimation/cellFrameAnimation.ts
var cellFrameAnimation = __webpack_require__(70);
...
// CONCATENATED MODULE: ./demo/frameAnimation/mainScene.ts
...
var mainScene_MainScene = (function (_super) {
    ...
    MainScene.prototype.onReady = function () {
        var _this = this;
        this.obj = new gameObject["a" /* GameObject */](this.game);
        var spr = new geometry_image["a" /* Image */](this.game);
        spr.setResourceLink(this.resourceLink);
        var anim = new cellFrameAnimation["a" /* CellFrameAnimation */](this.game);
        ...
        var playing = true;
        this.on(mouseEvents["a" /* MOUSE_EVENTS */].click, function () {
            playing = !playing;
            if (playing) {
                _this.obj.playFrameAnimation('animation');
            }
            else {
                _this.obj.stopFrameAnimation();
            }
        });
        window.obj = this.obj;
    };
...
// CONCATENATED MODULE: ./demo/frameAnimation/index.ts




var frameAnimation_game = new game["a" /* Game */]();
console.log(game["a" /* Game */].getInstance());
var mainScene = new mainScene_MainScene(frameAnimation_game);
frameAnimation_game.setRenderer(webGlRenderer["a" /* WebGlRenderer */]);
frameAnimation_game.addControl(mouseControl["a" /* MouseControl */]);
frameAnimation_game.runScene(mainScene);
