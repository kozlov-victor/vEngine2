...
var rect_1 = __webpack_require__(6);
var debugError_1 = __webpack_require__(0);
var mousePoint_1 = __webpack_require__(65);
var mouseEvents_1 = __webpack_require__(14);
...
var eventEmitterDelegate_1 = __webpack_require__(19);
var debugError_1 = __webpack_require__(0);
exports.FRAME_ANIMATION_EVENTS = {
    completed: 'completed',
    loop: 'loop'
};
var AbstractFrameAnimation = (function () {
    ...
    AbstractFrameAnimation.prototype.revalidate = function () {
        if ( true && !this.frames.length)
            throw new debugError_1.DebugError("animation frames can not be empty");
        this._timeForOneFrame = ~~(this.duration / this.frames.length);
        this.onNextFrame(0);
    };
    AbstractFrameAnimation.prototype.play = function () {
        if ( true && !this.parent)
            throw new debugError_1.DebugError("can not play frame animation: it is not attached to parent. Have you invoked ");
        this._isPlaying = true;
    };
    AbstractFrameAnimation.prototype.stop = function () {
        if ( true && !this.parent)
            throw new debugError_1.DebugError("can not stop frame animation: it is not attached to parent");
        this._isPlaying = false;
        this._startTime = 0;
        this._loopReached = false;
    };
    AbstractFrameAnimation.prototype.update = function () {
        ...
        if (this._loopReached && !this.isRepeat) {
            this.stop();
            this.trigger(exports.FRAME_ANIMATION_EVENTS.completed);
            return;
        }
        this._currFrame = currFrame;
        this.onNextFrame(currFrame);
        if (this._currFrame === this.frames.length - 1) {
            this.trigger(exports.FRAME_ANIMATION_EVENTS.loop);
...
exports.AbstractFrameAnimation = AbstractFrameAnimation;
...
Object.defineProperty(exports, "__esModule", { value: true });
var mainScene_1 = __webpack_require__(132);
var game_1 = __webpack_require__(4);
var webGlRenderer_1 = __webpack_require__(35);
var mouseControl_1 = __webpack_require__(64);
...
var cellFrameAnimation_1 = __webpack_require__(133);
var mouseEvents_1 = __webpack_require__(14);
var image_1 = __webpack_require__(32);
var MainScene = (function (_super) {
    ...
    MainScene.prototype.onReady = function () {
        ...
        var anim = new cellFrameAnimation_1.CellFrameAnimation(this.game);
...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(1);
var abstractFrameAnimation_1 = __webpack_require__(74);
var debugError_1 = __webpack_require__(0);
var CellFrameAnimation = (function (_super) {
    tslib_1.__extends(CellFrameAnimation, _super);
    ...
    CellFrameAnimation.prototype.revalidate = function () {
        if ( true && !this._spriteSheet)
            throw new debugError_1.DebugError("cellFrameAnimation needs spriteSheet! Invoke setSpriteSheet() method");
...
}(abstractFrameAnimation_1.AbstractFrameAnimation));
exports.CellFrameAnimation = CellFrameAnimation;
