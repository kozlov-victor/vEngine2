...
Object.defineProperty(exports, "__esModule", { value: true });
var tslib_1 = __webpack_require__(1);
var abstractKeypad_1 = __webpack_require__(71);
var KEYBOARD_KEY;
...
var KeyboardControl = (function (_super) {
    tslib_1.__extends(KeyboardControl, _super);
...
var gamePadGetterFactory = function () {
    if (navigator.getGamepads)
        return (function () { return navigator.getGamepads(); });
    else if (navigator.webkitGetGamepads)
        return (function () { return navigator.webkitGetGamepads(); });
    else {
        var possibles = ['webkitGamepads', 'mozGamepads', 'msGamepads', 'msGamepads'];
        var possible_1;
        for (var i = 0; i < possibles.length; i++) {
            if (navigator[possibles[i]]) {
                possible_1 = possibles[i];
                break;
            }
        }
        if ( true && !possible_1)
            throw new debugError_1.DebugError("can not use game pad: it is not supported by this device");
        return (function () { return navigator[possible_1]; });
    }
};
var gamePadGetter = gamePadGetterFactory();
var GamePadControl = (function (_super) {
    tslib_1.__extends(GamePadControl, _super);
    function GamePadControl(game) {
        var _this = _super.call(this, game) || this;
        _this.type = 'GamePadControl';
        return _this;
    }
    GamePadControl.prototype.update = function () {
        _super.prototype.update.call(this);
    ...
    GamePadControl.prototype.on = function (e, callback) {
        this.emitter.on(abstractKeypad_1.KEYBOARD_EVENT[e], callback);
    };
    GamePadControl.prototype.off = function (e, callback) {
        this.emitter.off(GAME_PAD_KEY[e], callback);
    };
    GamePadControl.prototype.listenTo = function () { };
    GamePadControl.prototype.destroy = function () { };
...
Object.defineProperty(exports, "__esModule", { value: true });
var mainScene_1 = __webpack_require__(86);
var game_1 = __webpack_require__(5);
var webGlRenderer_1 = __webpack_require__(35);
var keyboardControl_1 = __webpack_require__(74);
var gamePadControl_1 = __webpack_require__(75);
var game = new game_1.Game();
game.setRenderer(webGlRenderer_1.WebGlRenderer);
game.addControl(keyboardControl_1.KeyboardControl);
game.addControl(gamePadControl_1.GamePadControl);
...
var MainScene = (function (_super) {
    ...
    MainScene.prototype.onReady = function () {
        ...
        this.game.getControl(keyboardControl_1.KeyboardControl).on(abstractKeypad_1.KEYBOARD_EVENT.KEY_HOLD, function (e) {
            switch (e) {
                case keyboardControl_1.KEYBOARD_KEY.LEFT:
                    _this.logoObj.pos.addX(-1);
                    break;
                case keyboardControl_1.KEYBOARD_KEY.RIGHT:
                    _this.logoObj.pos.addX(1);
                    break;
                case keyboardControl_1.KEYBOARD_KEY.UP:
                    _this.logoObj.pos.addY(-1);
                    break;
                case keyboardControl_1.KEYBOARD_KEY.DOWN:
                    _this.logoObj.pos.addY(1);
                    break;
                case keyboardControl_1.KEYBOARD_KEY.R:
                    _this.logoObj.angle += 0.1;
            }
        });
        this.game.getControl(gamePadControl_1.GamePadControl).on(abstractKeypad_1.KEYBOARD_EVENT.KEY_HOLD, function (e) {
            switch (e) {
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_AXIS_LEFT:
                    _this.logoObj.pos.addX(-1);
                    break;
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_AXIS_RIGHT:
                    _this.logoObj.pos.addX(1);
                    break;
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_AXIS_UP:
                    _this.logoObj.pos.addY(-1);
                    break;
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_AXIS_DOWN:
                    _this.logoObj.pos.addY(1);
                    break;
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_1:
                    _this.logoObj.angle += 0.1;
                    break;
                case gamePadControl_1.GAME_PAD_KEY.GAME_PAD_3:
                    _this.logoObj.angle -= 0.1;
                    break;
            }
        });
